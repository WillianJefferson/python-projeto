...
class Ui_FrmAluguel(object):
    ...
    def btnSalvar_Click(self):
        print(self.gridCliente.currentItem())
    ...
    def setupUi(self, FrmAluguel):
        ...
        #AJUSTANDO MODO DE SELEÇÃO - Uma linha por vez, desalitar editar
        self.gridVeiculo.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.gridVeiculo.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.gridVeiculo.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
